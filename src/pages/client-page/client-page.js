...
class ClientPage extends Component {
    ...
    fetchData(extraValue) {
        fetch(`https://aplikacja-wsb.herokuapp.com/api/client-issues${(extraValue) ? `${extraValue}` : ""}`)
    ...
    getNotifications() {
        fetch(`https://aplikacja-wsb.herokuapp.com/api/get-all-notifications/${this.state.id}`)
            .then(res => res.json())
            .then(res => {    
                if(res) {
                    let dataToDisplay = [];
